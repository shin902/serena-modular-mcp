...
export const metaTools: Tool[] = [
  {
    ...
    description:
      "Reflect on and organize the information collected so far. Use this to synthesize findings and identify patterns.",
    inputSchema: {
      type: "object",
      properties: {
        context: {
  ...
  },
  {
    ...
    description:
      "Evaluate whether the current approach aligns with the task requirements.",
    inputSchema: {
      type: "object",
      properties: {
        task: {
  ...
  },
  {
    ...
    description:
      "Evaluate whether the task is complete and what remaining work exists.",
    inputSchema: {
      type: "object",
      properties: {
        task: {
  ...
  },
  {
    ...
    description:
      "Get initial instructions and guidelines for using Serena MCP effectively.",
    inputSchema: {
      type: "object",
      properties: {
        taskType: {
          type: "string",
          description:
            "Type of task (e.g., 'debug', 'implement', 'refactor', 'explore')",
        },
      },
    },
    handler: async (args) => {
